...
def conv(x, nf, sz, wd, p, stride=1):  # nf=48, sz=3, wd=1e-4, p=0
...
def create_tiramisu(nb_classes, img_input, nb_dense_block=6,
                    growth_rate=16, nb_filter=48, nb_layers_per_block=[4, 5, 7, 10, 12, 15]'''List Object''', p=0.2, wd=1e-4):

    if type(nb_layers_per_block) is list or type(nb_layers_per_block) is tuple:
        nb_layers = list(nb_layers_per_block) '''list function return List object'''
    else:
